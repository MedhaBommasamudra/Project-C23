...
function setup() {
    ...
    boxBody = Bodies.rectangle(width/2, height-70, 200, 20, {isStatic:true} )
    ...
    rigthBody = Bodies.rectangle(width/2+100,610,20,100, {isStatic:true})
    rigthSprite = createSprite(width/2+100,610,20,100)
	rigthSprite.shapeColor="red"
	World.add(world,rigthBody)
